...
png(file=paste(out,"na10km_v2_cru_4.00.2015.tmp.png",sep=""))
...
grid <- expand.grid(x=x, y=y)
cutpts <- c(-50,-25,-10,-5,0,5,10,15,25,40,50)
png(file=paste(out,"na10km_v2_cru_4.00.2015.dtr.png",sep=""))
...
grid <- expand.grid(x=x, y=y)
cutpts <- c(-50,-25,-10,-5,0,5,10,15,25,40,50)
png(file=paste(out,"na10km_v2_cru_4.00.2015.tmn.3d.1901.png",sep=""))
...
grid <- expand.grid(x=x, y=y)
cutpts <- c(-50,-25,-10,-5,0,5,10,15,25,40,50)
png(file=paste(out,"na10km_v2_cru_4.00.2015.tmx.3d.1901.png",sep=""))
...
grid <- expand.grid(x=x, y=y)
cutpts <- c(-50,-25,-10,-5,0,5,10,15,25,40,50)
png(file=paste(out,"na10km_v2_cru_4.00.2015.tmn.4d.1901.png",sep=""))
...
grid <- expand.grid(x=x, y=y)
cutpts <- c(-50,-25,-10,-5,0,5,10,15,25,40,50)
png(file=paste(out,"na10km_v2_cru_4.00.2015.tmx.4d.1901.png",sep=""))
...
ptm <- proc.time() # timer
ncfile <- "na10km_v2_cru_ts4.00.1901.2015.tmn.3d.nc"
...
ptm <- proc.time() # timer
ncfile <- "na10km_v2_cru_ts4.00.1901.2015.tmx.3d.nc"
...
ptm <- proc.time() # timer
ncfile <- "na10km_v2_cru_ts4.00.1901.2015.tmn.4d.nc"
tmn_ncfile <- paste(path,ncfile,sep="")
...
ptm <- proc.time() # timer
ncfile <- "na10km_v2_cru_ts4.00.1901.2015.tmx.4d.nc"
tmx_ncfile <- paste(path,ncfile,sep="")
