...
cutpts <- c(-1000,-500,-200,0,50,100,200,500,1000,2000,3000)
png(paste(out,"cru_ts4.00.pre.interp.2015.12.3d.png", sep=""))
...
grid <- expand.grid(x=x, y=y)
cutpts <- c(-1000,-500,-200,0,50,100,200,500,1000,2000,3000)
png(paste(out,"cru_ts4.00.pre.nonmiss.2015.12.3d.png", sep=""))
...
grid <- expand.grid(x=x, y=y)
cutpts <- c(-1000,-500,-200,0,50,100,200,500,1000,2000,3000)
png(paste(out,"cru_ts4.00.pre.near.2015.12.3d.png", sep=""))
...
interpfile <- "na10km_v2_cru_ts4.00.1901.2015.pre.anm3d.nc"
...
ptm <- proc.time() # timer
interpfile <- "na10km_v2_cru_ts4.00.1901.2015.pre.anm4d.nc"
interp_ncfile <- paste(natspath,interpfile,sep="")
