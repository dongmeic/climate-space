...
#
# utilities.py
# Source: https://bitbucket.org/labprentice/splash/src/
#   52d9454b566daf4f7e4f02b9d795aedd99fb53ff/releases/v1.0/py_version/
#   utilities.py?at=master&fileviewer=file-view-default
#
# VERSION: 1.0
...
def calculate_latitude(y, r):
    ...
    lat += (y * r)
    if isinstance(y, int):
        logging.debug("latitude at index %d is %f at resolution %0.3f"
                      % (y, lat, r))
    else:
