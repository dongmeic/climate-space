...
grid <- expand.grid(lon=lon, lat=lat)
cutpts <- c(0,5,10,15,20,25,30,35,40,45,50)
png(paste(out,"landmask_dtr.png", sep=""))
...
# define variable
dlname <- "diurnal temperature range"
...
# define variable
fillvalue <- 1e32
dlname <- "diurnal temperature range anomalies"
