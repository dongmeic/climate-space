...
fit <- rq(ddAugJul~year, tau=c(.05, .25, .5, .75, .95), data=df)
summary(fit)
fit <- rq(AugTmax~year, tau=c(.05, .25, .5, .75, .95), data=df)
summary(fit)
fit <- rq(winterTmin~year, tau=c(.05, .25, .5, .75, .95), data=df)
summary(fit)
fit <- rq(summerP0~year, tau=c(.05, .25, .5, .75, .95), data=df)
summary(fit)
fit <- rq(PPT~year, tau=c(.05, .25, .5, .75, .95), data=df)
summary(fit)
fit <- rq(GSP~year, tau=c(.05, .25, .5, .75, .95), data=df)
summary(fit)
fit <- rq(summerP1~year, tau=c(.05, .25, .5, .75, .95), data=df)
summary(fit)
fit <- rq(Tvar~year, tau=c(.05, .25, .5, .75, .95), data=df)
summary(fit)
sink()
