...
ncinfile_tmp <- paste0("na10km_v2_cru_ts4.01.",start_year,".",end_year,".tmp.abs3d.nc")
ncinfile_dtr <- paste0("na10km_v2_cru_ts4.01.",start_year,".",end_year,".dtr.abs3d.nc")
...
png(file=paste(out,"na10km_v2_cru_4.01.",end_year,".tmp.png",sep=""))
...
grid <- expand.grid(x=x, y=y)
cutpts <- c(-50,-25,-10,-5,0,5,10,15,25,40,50)
png(file=paste(out,"na10km_v2_cru_4.01.",end_year,".dtr.png",sep=""))
...
grid <- expand.grid(x=x, y=y)
cutpts <- c(-50,-25,-10,-5,0,5,10,15,25,40,50)
png(file=paste(out,"na10km_v2_cru_4.01.",end_year,".tmn.3d.png",sep=""))
...
grid <- expand.grid(x=x, y=y)
cutpts <- c(-50,-25,-10,-5,0,5,10,15,25,40,50)
png(file=paste(out,"na10km_v2_cru_4.01.",end_year,".tmx.3d.png",sep=""))
...
grid <- expand.grid(x=x, y=y)
cutpts <- c(-50,-25,-10,-5,0,5,10,15,25,40,50)
png(file=paste(out,"na10km_v2_cru_4.01.",end_year,".tmn.4d.png",sep=""))
...
grid <- expand.grid(x=x, y=y)
cutpts <- c(-50,-25,-10,-5,0,5,10,15,25,40,50)
png(file=paste(out,"na10km_v2_cru_4.01.",end_year,".tmx.4d.png",sep=""))
...
ptm <- proc.time() # timer
ncfile <- paste0("na10km_v2_cru_ts4.01.",start_year,".",end_year,".tmn.3d.nc")
...
ptm <- proc.time() # timer
ncfile <- paste0("na10km_v2_cru_ts4.01.",start_year,".",end_year,".tmx.3d.nc")
...
ptm <- proc.time() # timer
ncfile <- paste0("na10km_v2_cru_ts4.01.",start_year,".",end_year,".tmn.4d.nc")
tmn_ncfile <- paste(path,ncfile,sep="")
...
ptm <- proc.time() # timer
ncfile <- paste0("na10km_v2_cru_ts4.01.",start_year,".",end_year,".tmx.4d.nc")
tmx_ncfile <- paste(path,ncfile,sep="")
