...
crufile <- "cru_ts4.01.1901.2016.dtr.anm3d.nc"
...
cutpts <- c(-50,-25,-10,-5,0,5,10,15,25,40,50)
png(paste(out,"cru_ts4.01.dtr.interp.2016.12.3d.png", sep=""))
...
grid <- expand.grid(x=x, y=y)
cutpts <- c(-50,-25,-10,-5,0,5,10,15,25,40,50)
png(paste(out,"cru_ts4.01.dtr.nonmiss.2016.12.3d.png", sep=""))
...
grid <- expand.grid(x=x, y=y)
cutpts <- c(-50,-25,-10,-5,0,5,10,15,25,40,50)
png(paste(out,"cru_ts4.01.dtr.near.2016.12.3d.png", sep=""))
...
interpfile <- "na10km_v2_cru_ts4.01.1901.2016.dtr.anm3d.nc"
...
ptm <- proc.time() # timer
interpfile <- "na10km_v2_cru_ts4.01.1901.2016.dtr.anm4d.nc"
interp_ncfile <- paste(natspath,interpfile,sep="")
