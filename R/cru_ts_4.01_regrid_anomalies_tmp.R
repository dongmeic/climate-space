...
crufile <- "cru_ts4.01.1901.2016.tmp.anm3d.nc"
...
cutpts <- c(-10,-5,-2,-1,-.5,0,.5,1,2,5,10)
png(paste(out,"cru_ts4.01.tmp.interp.2015.12.3d.png", sep=""))
...
grid <- expand.grid(x=x, y=y)
cutpts <- c(-10,-5,-2,-1,-.5,0,.5,1,2,5,10)
png(paste(out,"cru_ts4.01.tmp.nonmiss.2015.12.3d.png", sep=""))
...
grid <- expand.grid(x=x, y=y)
cutpts <- c(-10,-5,-2,-1,-.5,0,.5,1,2,5,10)
png(paste(out,"cru_ts4.01.tmp.near.2016.12.3d.png", sep=""))
...
interpfile <- "na10km_v2_cru_ts4.01.1901.2016.tmp.anm3d.nc"
...
ptm <- proc.time() # timer
interpfile <- "na10km_v2_cru_ts4.01.1901.2016.tmp.anm4d.nc"
interp_ncfile <- paste(interppath,interpfile,sep="")
