...
crufile <- "cru_ts4.00.1901.2015.dtr.anm3d.nc"
...
cutpts <- c(-50,-25,-10,-5,0,5,10,15,25,40,50)
png(paste(out,"cru_ts4.00.dtr.interp.2015.12.3d.png", sep=""))
...
grid <- expand.grid(x=x, y=y)
cutpts <- c(-50,-25,-10,-5,0,5,10,15,25,40,50)
png(paste(out,"cru_ts4.00.dtr.nonmiss.2015.12.3d.png", sep=""))
...
grid <- expand.grid(x=x, y=y)
cutpts <- c(-50,-25,-10,-5,0,5,10,15,25,40,50)
png(paste(out,"cru_ts4.00.dtr.near.2015.12.3d.png", sep=""))
...
ptm <- proc.time() # timer
natspath <- "/home2/dongmeic/beetle/ncfiles/na10km_v2/ts/"
interpfile <- "na10km_v2_cru_ts4.00.1901.2015.dtr.anm3d.nc"
...
ptm <- proc.time() # timer
interpfile <- "na10km_v2_cru_ts4.00.1901.2015.dtr.anm4d.nc"
interp_ncfile <- paste(natspath,interpfile,sep="")
