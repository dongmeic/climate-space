...
inpath <- "/gpfs/projects/gavingrp/dongmeic/beetle/output/tables/daily_climate/Daymet"; setwd(inpath)
...
foreach(k = 1:nvar)%dopar%{
  ...
  ncatt_put(ncout,0,"source","generated by daymet_bioclim_ncfiles.R")
