...
# mpb
ncfname <- paste(ncpath,"prs/na10km_v2_mpb_presence_fishnet.nc", sep="")
dname <- "mpb_prs"
...
indata <- cbind(na10km,btl_fishnet@data[,6:25])
str(indata)
print("done!")
...
ncatt_put(ncout,0,"source","generated by na10km_v2_ncfiles_3d_btl_fishnet.R")
