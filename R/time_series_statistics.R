...
outdata <- ndf[,c(1:2, 23:41)]
#write.csv(outdata,paste0(csvpath, "ts_presence_statistics.csv"), row.names=FALSE)
write.csv(outdata,paste0(csvpath, "ts_alteration.csv"), row.names=FALSE)
...
ncfname <- paste(ncpath,"prs/time_series_alteration_statistics.nc", sep="")
#csvfile <- "ts_presence_statistics.csv"
csvfile <- "ts_alteration.csv"
dname <- "prs_alt"
